...
interface AsenTokenInterface extends ethers.utils.Interface {
  functions: {
...
export type BlackListAddedEvent = TypedEvent<[string] & { _account: string }>;

export type BlackListRemovedEvent = TypedEvent<[string] & { _account: string }>;
...
export class AsenToken extends BaseContract {
  ...
  callStatic: {
    ...
    addToBlackList(_account: string, overrides?: CallOverrides): Promise<void>;
